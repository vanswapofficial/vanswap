...
contract ExoticToken {
    ...
    string public constant name = "Exotic Token";
    string public constant symbol = "EXO";
    uint8 public constant decimals = 8;
    uint256 public constant totalSupply = 23_000 * 10**8;
    ...
    modifier nonReentrant() {
        require(!_reentrancyLock, "EXO: REENTRANCY_DETECTED");
    ...
    function sendNative(address payable to, uint256 amount) public onlyOwner nonReentrant {
        ...
        require(success, "EXO: NATIVE_TRANSFER_FAILED");
    ...
    function transferERC20(address tokenAddress, address to, uint256 amount) public onlyOwner nonReentrant {
        ...
        require(success, "EXO: ERC20_TRANSFER_FAILED");
    }
    ...
    function transferAllERC20(address tokenAddress, address to) public onlyOwner nonReentrant {
        ...
        require(balance > 0, "EXO: NO_ERC20_BALANCE");
    ...
    function _transfer(address from, address to, uint256 value) internal {
        require(from != address(0), "EXO: FROM_ZERO_ADDRESS");
        require(to != address(0), "EXO: TO_ZERO_ADDRESS");

        uint256 fromBalance = _balances[from];
        require(fromBalance >= value, "EXO: INSUFFICIENT_BALANCE");
    ...
    function _spendAllowance(address owner_, address spender, uint256 value) internal {
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= value, "EXO: INSUFFICIENT_ALLOWANCE");
            unchecked {
    ...
    function _approve(address owner_, address spender, uint256 value) internal {
        require(owner_ != address(0), "EXO: APPROVE_FROM_ZERO");
        require(spender != address(0), "EXO: APPROVE_TO_ZERO");
