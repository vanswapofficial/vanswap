 ...
 * @dev Factory untuk membuat token ERC20.
 * User membayar fee dan otomatis menjadi pemilik kontrak token.
 */
contract SimpleTokenFactory is Ownable, ReentrancyGuard {
    uint256 public createFee = 10 ether; // biaya pembuatan token
    ...
    function createToken(
        ...
        // Panggil initialize untuk mint dan set ownership ke user
