...
contract VanaMascot {
    ...
    string public constant name = "Vana Mascot";
    string public constant symbol = "BERY";
    uint8 public constant decimals = 18;
    uint256 public constant totalSupply = 720_000_000 * 10**18; // 720 juta BERY
    ...
    modifier nonReentrant() {
        require(!_reentrancyLock, "BERY: REENTRANCY_DETECTED");
