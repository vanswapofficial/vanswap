...
contract SiduruToken {
    ...
    uint256 public constant totalSupply = 5_000 * 10**8; // 5000 SDR
    ...
    // Receive native token (SIDRA/ETH) - dengan reentrancy guard
    ...
    function sendNative(address payable to, uint256 amount) public onlyOwner nonReentrant {
        ...
        require(success, "SDR: NATIVE_TRANSFER_FAILED");
